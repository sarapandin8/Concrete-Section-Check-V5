...
def build_pmm_solver_validation_matrix() -> list[ValidationCaseSpec]:
    ...
    return [
        ...
        ValidationCaseSpec(
            ...
            next_action="Keep this gate in force until PMM.UI.STATUS1 updates commercial wording after benchmark closure.",
        ...
        ValidationCaseSpec(
            ...
            acceptance="Directional capacity for nonzero Mux and Muy is not overestimated and the governing D/C path remains traceable.",
            source="Future independent or published biaxial PMM reference example.",
            current_location="docs/design/pmm_final_rc1.md",
            next_action="Implement a named true-biaxial benchmark pack and compare solver/D-C output against reference values.",
        ...
        ValidationCaseSpec(
            ...
            acceptance="Ray-envelope D/C is the preferred method; fallback paths remain visible and benchmarked, with no silent convex-hull overestimate accepted.",
            source="VALID.PMM.DC1 synthetic ray-envelope checks plus future RC reference cases.",
            ...
            next_action="Add RC-specific non-circular/non-symmetric D/C benchmark cases and fallback governance tests.",
