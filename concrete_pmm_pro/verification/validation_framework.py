...
def build_pmm_solver_validation_matrix() -> list[ValidationCaseSpec]:
    ...
    return [
        ...
        ValidationCaseSpec(
            ...
            title="Prestress compression reversal classification",
            category="Prestress PMM",
            status="partial",
            purpose="Detect compression-reversal events and classify whether they are background PMM-surface events or governing-impact events.",
            acceptance="Compression-reversal warnings are actionable and governing-impact classification tests pass; root stress model remains documented.",
            ...
            warnings_addressed=("compression reversal",),
        ),
        ValidationCaseSpec(
